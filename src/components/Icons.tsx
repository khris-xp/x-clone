...
export const MediaIcon = ({ fill }: Props) => {
    return (
...
export const GifIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
...
export const EmojiIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
...
export const ScheduleIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
...
export const ReplyIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
...
export const RetweetIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
...
export const LikeIcon = ({ fill }: Props) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" className={fill}>
            <g>
